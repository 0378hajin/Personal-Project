...
function check() {
	...
	if (fm.subject.value == "") {
		...
		fm.content.focus();
		return;
	} else if (fm.link.value == "") {
		alert("판매 페이지 링크를 입력해주세요.");
		fm.link.focus();
		return;
	} else if (fm.cost.value == "") {
		alert("가격을 입력해주세요.");
		fm.cost.focus();
		return;
	} else if (fm.del_cost.value == "") {
		alert("배송비를 입력해주세요.");
		fm.del_cost.focus();
		return;
	}
	fm.action = "<%=request.getContextPath()%>/board/hotdealBoard_writeAction.do";
	fm.method = "post";
	fm.submit;
}
...
<br>
<div id = "news" style = "width : 73%; height: auto;">
...
<tr>
<td style = "width : 12%; text-align : right; font-family : Arial;">판매 사이트 :</td>
<td><input type = "text" name = "link" style = "width : 100%"></td>
</tr>

<tr>
<td style = "width : 12%; text-align : right; font-family : Arial;">가격 : </td>
<td><input type = "text" name = "cost" placeholder = "ex) 1000원" style = "width : 25%; text-align : right;"></td>
</tr>

<tr>
<td style = "width : 12%; text-align : right; font-family : Arial;">배송비 : </td>
<td><input type = "text" name = "del_cost" placeholder = "ex) 무료배송" style = "width : 25%; text-align : right;"></td>
</tr>
</table>
<br>
