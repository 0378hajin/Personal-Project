...
<th id = "hover"><a class = "sellist" href= "<%=request.getContextPath()%>/board/communityBoardList.do">전체</a></th>
<th id = "hover" style = "background :#627062;"><a class = "sellist" href= "<%=request.getContextPath()%>/board/communityBoardList_answer.do">질문</a></th>
...
<tr class = "tab22">
	...
	<%if(bv.getKind().equals("answer")) {%>
	질문
	<% } %>
	<%if(bv.getKind().equals("reply")) {%>
	답변
	<% } %>
	</td>
...
<tr>
	...
	<%
	if(pm.isPrev() == true){
		out.println("<a href = '"+request.getContextPath()+"/board/communityBoardList_answer.do?page="+(pm.getStartPage()-1)+"&keyword="+pm.encoding(pm.getScri().getKeyword())+"&searchType="+pm.getScri().getSearchType()+"'>이전</a>");
	}	
	...
	for(int i = pm.getStartPage(); i <= pm.getEndPage(); i++){
		...
		out.println("<a href = '"+request.getContextPath()+"/board/communityBoardList_answer.do?page="+i+"&keyword="+pm.encoding(pm.getScri().getKeyword())+"&searchType="+pm.getScri().getSearchType()+"'>"+i+"</a>");
	}
	...
	if(pm.isNext() && pm.getEndPage() > 0) {
		out.println("<a href = '"+request.getContextPath()+"/board/communityBoardList_answer.do?page="+(pm.getEndPage()+1)+"&keyword="+pm.encoding(pm.getScri().getKeyword())+"&searchType="+pm.getScri().getSearchType()+"'>다음</a>");
	}
...
<td style = "width : 100%;">
<form name = "frm" id = "searchbar" action = "<%=request.getContextPath()%>/board/communityBoardList_answer.do" method = "post">
