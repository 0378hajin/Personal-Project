...
function check() {
	...
	fm.action = "<%=request.getContextPath()%>/board/communityBoard_replyAction.do";
	fm.method = "post";
	fm.submit;
}
...
<select name = kind id = "sel">
	<option value = "community" selected>게시판 선택</option>
...
<input type="button" name = "btn2" value="취소" onclick= "location.href = '<%=request.getContextPath()%>/board/communityBoardList.do'" id = "close"> 
</span>
</div>
...
<input type = "button" name = "myInfo" value = "작성글 보기" id = "join" onclick = "location.href = '<%=request.getContextPath() %>/board/myNewsWrite.do'" style = "width : 31%; height : 30px;">
<input type = "button" name = "myInfo" value = "내 정보" id = "join" onclick = "location.href = '<%=request.getContextPath()%>/main/myInfo.do'" style = "width : 31%; height : 30px;">
<input type = "button" name = "myInfo" value = "로그아웃" id = "join" onclick = "location.href = '<%=request.getContextPath()%>/main/logout.do'" style = "width : 31%; height : 30px;">
</form>
</div>
