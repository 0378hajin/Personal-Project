...
<form>
<input type = "button" name = "login" value = "로그인" onclick = "" id = "join" style = "width : 100%; height : 50px;">
<br>
<br>
<input type = "button" name = "join" value = "회원가입" onclick = "" id = "join" style = "width : 100%; height : 50px;">
<br>
<br>
<br>
<a class = "logfont" href = "">아이디</a> * <a  class = "logfont" href = "">비밀번호 찾기</a> 
</form>
</div>
