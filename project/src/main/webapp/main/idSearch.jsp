...
function check() {
	...
	fm.action = "<%=request.getContextPath()%>/main/idSearchAction.do";
	fm.method = "post";
	fm.submit();
}
</script>
...
<tr>
	<td id = "td"><input type = "text" name = "membernickname" value = "" style = "border-radius : 10px; border : 1px solid gray"></td>	
</tr>
...
<tr>
	<td id = "td"><input type = "email" name = "membermail" value = "" style = "border-radius : 10px; border : 1px solid gray"></td>	
</tr>
